...
.Java 7
----
Conference conference = conferenceService.findConferenceByTitle("CodeMotion Madrid 2014"); //<1>

assertThat(conference.getTitle(), is("CodeMotion Madrid 2014"));
----
<1> Entity Manager
...
.Java8
----
Conference book = Optional.ofNullable(
                    conferenceService.findConferenceByTitle("CodeMotion Madrid 2014")
                  ).orElse(new Conference());
assertThat(book.getTitle(), is("CodeMotion Madrid 2014"));
----
--
...
Calendar earlyBirdLimitOld = codeMotion.getEarlyBirdLimitOld();
...
.Java 8
----
LocalDate initialDate = LocalDate.of(1996, 8, 6);
conference.setInitial(initialDate);
...
engine.eval(new FileReader("src/main/webapp/resources/js/validate.js"));
Invocable invocable = (Invocable) engine;

Validate validate = invocable.getInterface(Validate.class);
assertThat(validate.checkEmail("a@a.es"), is(true));
----
...
* Slide 18 - https://www.flickr.com/photos/luccast85
* Slide 46 - http://img.movieboom.biz/movie/screen/415/18.jpg
* Slide 57 - Mine
